...
export default function HelpPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // SIMULATION: In a real application, this would send data to a backend endpoint
    // which would then use a service (e.g., SendGrid, Nodemailer) to send an email
    // to offeriumcontact@gmail.com.
    console.log("SIMULATING EMAIL SUBMISSION TO offeriumcontact@gmail.com with data:", { name, email, subject, message });
    ...
    <div className="container mx-auto px-4 md:px-6 py-12 space-y-12">
      ...
      <Card className="max-w-2xl mx-auto shadow-xl">
        <CardHeader>
          ...
          <CardDescription>
            Completa el siguiente formulario y nuestro equipo de soporte se pondrá en contacto contigo a la brevedad. (Nota: Este es un formulario de simulación y no enviará un correo real).
          </CardDescription>
        </CardHeader>
        <CardContent>
